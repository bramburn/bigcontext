...
export class SetupView {
    ...
    private setupMessageHandlers(): void {
        ...
        vscodeApi.onMessage('databaseStatus', (data) => {
            if (this.databaseSetup) {
                this.databaseSetup.handleDatabaseStatusUpdate(data.status);
            }
        });
        ...
        vscodeApi.onMessage('error', (data) => {
            setupActions.setError(data.message);
        });
    }
     ...
     */
    private async handleStartIndexing(): void {
