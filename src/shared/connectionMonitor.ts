...
export type ConnectionEventType = 'connected' | 'disconnected' | 'reconnecting' | 'error' | 'heartbeat';
...
export class ConnectionMonitor {
    ...
    private messageQueue: Array<{ message: any; timestamp: number; retries: number }> = [];
